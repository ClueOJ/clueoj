...
from judge.views.select2 import AssigneeSelect2View, CommentSelect2View, ContestSelect2View, \
    ...
    MirrorProblemSelect2View, ProblemSelect2View, TagGroupSelect2View, TagSelect2View, TicketUserSelect2View, UserSearchSelect2View, \
    UserSelect2View
...
urlpatterns = [
    ...
    path('contest/<str:contest>', include([
        ...
        path('/public-ranking/create', contests.ContestPublicRankingLinkCreate.as_view(),
             name='contest_public_ranking_create'),
        path('/public-ranking/update', contests.ContestPublicRankingLinkUpdate.as_view(),
             name='contest_public_ranking_update'),
        path('/public-ranking/regenerate', contests.ContestPublicRankingLinkRegenerate.as_view(),
    ...
    path('organization/<slug:slug>', include([
        ...
        path('/users/add', organization.OrganizationAddMembers.as_view(), name='organization_add_members'),
        path('/users/remove', organization.OrganizationRemoveMembers.as_view(), name='organization_remove_members'),
        path('/extend-temporarily', organization.OrganizationTemporaryExtension.as_view(),
             name='organization_temporary_extension'),
    ...
    path('judge-select2/', include([
        ...
        path('mirror-problem/', MirrorProblemSelect2View.as_view(), name='mirror_problem_select2'),
