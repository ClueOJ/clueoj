...
VNOJ_IGNORED_ORGANIZATION_SUBDOMAINS = ['oj', 'mirror', 'www', 'localhost', '@', '']
...
DMOJ_PROBLEM_MAX_TIME_LIMIT = 36000  # seconds
DMOJ_PROBLEM_MIN_MEMORY_LIMIT = 0  # kilobytes
DMOJ_PROBLEM_MAX_MEMORY_LIMIT = 2097152  # kilobytes
...
DMOJ_USER_MAX_ORGANIZATION_COUNT = 1000
DMOJ_OPEN_ORGANIZATION_DEFAULT_SLOTS = 50
