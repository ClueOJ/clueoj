...
class ContestProblemInline(SortableInlineAdminMixin, admin.TabularInline):
    ...
    fields = ('problem', 'points', 'partial', 'is_pretested', 'max_submissions', 'hidden_subtasks', 'output_prefix_override', 'order',
...
class ContestAdmin(NoBatchDeleteMixin, VersionAdmin):
    fieldsets = (
        ...
        (_('Settings'), {'fields': ('is_visible', 'use_clarifications', 'push_announcements', 'disallow_virtual',
                                    ...
                                    'run_pretests_only', 'has_hidden_subtasks', 'show_number_of_submission', 'offline_mode', 'locked_after', 'scoreboard_visibility',
