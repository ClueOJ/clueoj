...
from judge.models import Badge, BlogPost, Comment, CommentLock, Contest, ContestParticipation, ExamCategory, \
    ExamProvince, ExamTag, ContestTag, Judge, Language, License, MiscConfig, NavigationBar, Organization, \
...
admin.site.register(ExamTag, ExamTagAdmin)
