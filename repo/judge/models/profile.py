...
class Organization(models.Model):
    ...
    available_credit = models.IntegerField(default=99999999)
    current_consumed_credit = models.IntegerField(default=0)
    monthly_credit = models.IntegerField(default=0)
    monthly_free_credit_limit = models.IntegerField(default=9999999)
