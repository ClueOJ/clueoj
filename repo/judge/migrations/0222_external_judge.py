...
class Migration(migrations.Migration):
    dependencies = [
        ('judge', '0221_contestpublicrankinglink'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_mappings', models.JSONField(blank=True, default=list, help_text='List of mappings with clueoj_key, vjudge_id, and vjudge_name.', verbose_name='language mappings')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['config', 'oj', 'external_problem_id'], name='judge_exter_config__c73f93_idx')],
            },
        ),
    ]
